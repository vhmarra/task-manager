...
public class UserService extends TokenService {
    ...
    public UserService(UserRepository userRepository, ValidationService validator, ProfileService profileService, EmailRepository emailRepository, AccessTokenRepository accessTokenRepository) {
    ...
    public void authenticateUser(String cpf, String pass) throws NotFoundException {
        ...
        log.info("token na thread {}",getAccessToken());
